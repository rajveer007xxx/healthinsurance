...
from app.routers import (
    ...
    employees, permissions, notifications, settings, uploads, superadmin,
    manual_invoices
)
...
app.include_router(manual_invoices.router, prefix="/manual-invoices", tags=["Manual Invoices"])
