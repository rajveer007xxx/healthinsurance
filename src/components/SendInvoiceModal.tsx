...
export default function SendInvoiceModal({ isOpen, onClose, preSelectedCustomer }: SendInvoiceModalProps) {
  ...
  const [items, setItems] = useState<InvoiceItem[]>([
    { id: '1', sl_no: 1, particulars: '', units: 1, price: 0, amount: 0 }
  ])
  ...
  const addItem = () => {
    ...
    setItems([...items, { id: newId, sl_no: newSlNo, particulars: '', units: 1, price: 0, amount: 0 }])
  }
              ...
              <table className="w-full">
                ...
                <tfoot className="bg-gray-100">
                  <tr>
                    ...
                    <td className="px-3 py-3 font-bold text-teal-800 text-lg">₹{totalAmount.toFixed(2)}</td>
                    <td></td>
                  </tr>
                </tfoot>
              </table>
