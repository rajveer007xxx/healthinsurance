...
export default function Login({ setIsAuthenticated }: LoginProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-600 via-teal-600 to-cyan-600">
      <Card className="w-full max-w-md mx-4 shadow-2xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-base">
            Sign in to access your field tasks
          </CardDescription>
        </CardHeader>
        <CardContent>
